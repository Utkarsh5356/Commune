    ...
    return (
     <Card className="w-full max-w-sm">
       ...
       <div className="px-7 -mt-6">
        ...
        <Input className="text-sm text-gray-800 font-normal"></Input>
       ...
       <div className="relative">
          <Input type={showPassword ? "text" : "password"} className="text-sm text-gray-800 pr-13"></Input>
           <div onClick={()=>setShowPassword(!showPassword)} className="cursor-pointer">
            ...
            <svg className="absolute top-4.5 left-66 h-5" width="64px" height="64px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier">
